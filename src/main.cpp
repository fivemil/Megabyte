...
static const int64 nTargetTimespan = 2.5 * 60; // 1 minutes (NUM_ALGOS * 30 seconds) readjusts difficulty
static const int64 nTargetTimespan2 = 1 * 60; // 1 minutes (NUM_ALGOS * 30 seconds) readjusts difficulty

static const int64 nTargetSpacing = 2.5 * 60; // 1 minutes (NUM_ALGOS * 30 seconds) between blocks
static const int64 nTargetSpacing2 = 2.5 * 60; // 1 minutes (NUM_ALGOS * 30 seconds) between blocks

static const int64 nInterval = 1; // retargets every 2 blocks
static const int64 nInterval2 = 2; // retargets every 2 blocks
...
static const int64 nMaxAdjustDown = 4; // 100% adjustment down
static const int64 nMaxAdjustDown1 = 100; // 100% adjustment down
static const int64 nMaxAdjustDown2 = 10; // 10% adjustment down
static const int64 nMaxAdjustDown3 = 5; // 5% adjustment down

static const int64 nMaxAdjustUp = 2; // 10% adjustment up
static const int64 nMaxAdjustUp1 = 10; // 10% adjustment up
